...
async def generate_paragraph(request: StoryRequest):
    try:
        ...
        system_prompt = f"You are a creative writer specializing in {request.genre} stories. Write in a {request.style} style, following the {request.type} story structure."
